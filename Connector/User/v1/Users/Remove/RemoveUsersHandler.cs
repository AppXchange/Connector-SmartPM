...
public class RemoveUsersHandler : IActionHandler<RemoveUsersAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<RemoveUsersActionOutput>();
            // response = await _apiClient.PostUsersDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetUsersDataObject(response.Data.id, cancellationToken);

            // var resource = new RemoveUsersActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "RemoveUsersHandler" };
