...
public class DeleteCompanyUsersHandler : IActionHandler<DeleteCompanyUsersAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<DeleteCompanyUsersActionOutput>();
            // response = await _apiClient.PostCompanyUsersDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetCompanyUsersDataObject(response.Data.id, cancellationToken);

            // var resource = new DeleteCompanyUsersActionOutput
            // {
            //      TODO : map
            // };
