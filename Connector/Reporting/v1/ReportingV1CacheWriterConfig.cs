...
public class ReportingV1CacheWriterConfig
{
    // Data Reader configuration
    public CacheWriterObjectConfig ShouldStartFinishReportConfig { get; set; } = new();
    public CacheWriterObjectConfig ShouldStartFinishTrendConfig { get; set; } = new();
    public CacheWriterObjectConfig MonthlyDistributionConfig { get; set; } = new();
}