...
public class UploadUploadFileHandler : IActionHandler<UploadUploadFileAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<UploadUploadFileActionOutput>();
            // response = await _apiClient.PostUploadFileDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetUploadFileDataObject(response.Data.id, cancellationToken);

            // var resource = new UploadUploadFileActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "UploadUploadFileHandler" };
